...
class FinetuningArguments:
    ...
    finetuning_type: Optional[Literal["lora", "freeze", "full", "pt", "pt2", "none"]] = field(
        default="pt2",
    ...
    def __post_init__(self):
        ...
        assert self.finetuning_type in ["lora", "freeze", "full", "pt", "pt2", "none"], "Invalid fine-tuning method."
