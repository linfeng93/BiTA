...
EXPERIMENT_NAME="vicuna-13b-chat-prompt-$prompt_num-mask-$mask_num"
...
deepspeed $DISTRIBUTED_ARGS src/train_bash.py \
  ...
  --stage sft \
  --finetuning_type pt2 \
  --model_name_or_path $ROOT_DIR/checkpoints/vicuna-13b-v1.3-hf\
  --dataset assembled_prompt_gen-vicuna13b,assembled_prompt2_gen-vicuna13b \
