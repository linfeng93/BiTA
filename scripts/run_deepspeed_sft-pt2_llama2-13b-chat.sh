...
EXPERIMENT_NAME="llama-2-13b-chat-prompt-$prompt_num-mask-$mask_num"
...
deepspeed $DISTRIBUTED_ARGS src/train_bash.py \
  ...
  --stage sft \
  --finetuning_type pt2 \
  --model_name_or_path $ROOT_DIR/checkpoints/Llama-2-13b-chat-hf \
  --dataset assembled_prompt_gen-13b,assembled_prompt2_gen-13b \
