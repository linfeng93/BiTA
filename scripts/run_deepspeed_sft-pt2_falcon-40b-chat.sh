...
EXPERIMENT_NAME="falcon-40b-chat-prompt-$prompt_num-mask-$mask_num"
DATESTR=$(date +"%m-%d-%H")
...
deepspeed $DISTRIBUTED_ARGS src/train_bash.py \
  ...
  --stage sft \
  --finetuning_type pt2 \
  --model_name_or_path $ROOT_DIR/checkpoints/falcon-40b-instruct-hf\
  --dataset assembled_prompt2_gen-falcon40b \
